                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select class="form-control select2" id="product_id" name="product_id" data-error=".productiderror" style="width: 100%;">
                                    ...
                                    ?>
                                                <option value="<?php echo $value['product_id']; ?>" data-price="<?php echo $value['d_p']; ?>" data-thumbnail="<?php echo $value['thumbnail']; ?>"><?php echo $value['name']; ?></option>
                                    <?php
                                            }
                                        }
                                    ?>
...
<form id="formId" method="POST" action="<?php echo base_url().customer_orders_constants::place_customer_order_url; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="customer_id" name="customer_id" data-error=".customeriderror" style="width: 100%;">
                                ...
                                <div class="customeriderror error_msg"></div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">GST Type: <span class="asterisk">*</span></label>
                                <select class="select2" name="gst_type" id="gst_type" style="width: 100%;" data-error=".gsttypeerror" required>
...
<script type="text/javascript">
    ...
    $('#product_id, #customer_id, #gst_type').select2();
