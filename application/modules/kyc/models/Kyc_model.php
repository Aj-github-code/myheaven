<?php
    ...
    {
        private $table_kyc          = kyc_table::sql_table_kyc;
        private $table_franchise    = signin_table::sql_tbl_users;
        ...
        function save($id='', $save_data=[])
        {
            ...
            if(!empty($save_data))
            {
                ...
                {
                    $this->db->where('id', $id);
                    $this->db->update($this->table_kyc, $save_data);
                }
                else
                {
                    $this->db->insert($this->table_kyc, $save_data);
                ...
                if($this->db->affected_rows())
                {
                    ...
                    $response = ['error' => 0, 'message' => 'Kyc document successfully saved'];
                }
                else
                {
                    $response = ['error' => 1, 'message' => 'Unable to save kyc document'];
                }
            }
            return $response;
        }
