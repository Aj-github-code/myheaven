                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td><span>Total B.V.</span></td>
                                <td><h2 class="price text-right mb-0">₹<?php echo handle_number_format($order['total_b_v']); ?></h2></td>
                            </tr>
                            <tr>
...
<div class="modal" id="order-process-modal">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content modal-content-demo">
            <form id="order-form-id" method="POST" action="<?php echo base_url(repurchase_constants::process_repurchase_url); ?>">
