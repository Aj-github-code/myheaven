...
{
	var img_folder_url = assets_url+'custom_plugins/multiple_file_uploader/';
		...
		if(this.vpb_files.length > 0)
		{
 			...
 			for(var i = 0; i<this.vpb_files.length; i++)
			{
				...
				if(typeof this.vpb_files[i] != undefined && this.vpb_files[i].name != "")
				{
					...
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/images_file.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "doc" || vpb_file_to_add == "docx" || vpb_file_to_add == "rtf" || vpb_file_to_add == "DOC" || vpb_file_to_add == "DOCX" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/doc.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "pdf" || vpb_file_to_add == "PDF" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/pdf.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "txt" || vpb_file_to_add == "TXT" || vpb_file_to_add == "RTF" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/txt.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "php" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/php.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "css" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/general.png" align="absmiddle" border="0" alt="" />';
					}
					...
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/html.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "setup" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/setup.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "video" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/video.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "real" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/real.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "psd" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/psd.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "fla" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/fla.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "xls" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/xls.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "swf" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/swf.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "eps" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/eps.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "exe" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/exe.gif" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "binary" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/binary.png" align="absmiddle" border="0" alt="" />';
					}
					else if( vpb_file_to_add == "zip" )
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/archive.png" align="absmiddle" border="0" alt="" />';
					}
					else
					{
						vpb_file_icon = '<img src="'+img_folder_url+'images/general.png" align="absmiddle" border="0" alt="" />';
					...
					vpb_added_files_displayer += `
													<tr id="add_fileID`+vpb_file_id+`" class="`+new_classc+`">
														<td id="vpb_files_left">
															`+vpb_file_icon+` `+this.vpb_files[i].name.substring(0, 40)+`
														</td>
														<td>
														...
														<td>`+vpb_actual_fileSize+`</td>
														<td>`+strDate+`</td>
														<td>
															<div id="vpb_files_remove_left">
																<span id="remove`+vpb_file_id+`">
	...
	vpb_multiple_file_uploader.prototype.vpb_read_file = function(vpb_e) {
		if(vpb_e.target.files) {
			$('#upload_images_wrap').removeClass('d-none');
			$('#input_file_wrap').addClass('d-none');
		...
		if(typeof file[file_counter] != undefined && file[file_counter] != '')
		{
			...
			else
			{
				...
				$.ajax({
					...
					beforeSend: function() 
					{
						$("#uploading_"+ids).html('<div align="left"><img src="'+img_folder_url+'images/loadings.gif" width="80" align="absmiddle" title="Upload...."/></div>');
