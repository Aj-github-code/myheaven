$(function() {
	...
	$('#sparkel3').sparkline('html', {
		...
		highlightSpotColor: null,
		highlightLineColor: null,
		fillColor: 'rgba(111, 66, 193, 0.09) ',
		chartRangeMin: 0,
		chartRangeMax: 10,
		width: '100%',
		height: 30,
	...
	/* Chartjs (#chartDonut) */
      ...
      var gradientStrokeone = ctx.createLinearGradient(0, 0, 0, 80);
      gradientStrokeone.addColorStop(0, 'rgb(56, 88, 249)');
      gradientStrokeone.addColorStop(1, 'rgba(56, 88, 249,0.9)');
      var gradientLegendone = 'linear-gradient(45deg,#3858f9,#8e79fd)';

      var gradientStroketwo = ctx.createLinearGradient(0, 0, 0, 181);
